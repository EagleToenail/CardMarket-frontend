  ...
  return (
    <>
      ...
      {(showNext && showPrizeFlag) ? (
        <button
          className="fixed flex flex-wrap items-center right-4 bottom-14 border-1 cursor-pointer hover:opacity-50 opacity-80 text-white text-center text-lg rounded-md px-3 py-1"
          style={{ backgroundColor: bgColor }}
          onClick={() => nextPrize()}
        >
          {t("next")}
      ...
      <button
        className="fixed flex flex-wrap items-center bottom-14 right-4 border-1 cursor-pointer hover:opacity-50 opacity-80 text-white text-center text-lg rounded-md px-3 py-1"
        style={{ backgroundColor: bgColor }}
        onClick={() => finishPrize()}
      >
        {t("skipVideo")}
